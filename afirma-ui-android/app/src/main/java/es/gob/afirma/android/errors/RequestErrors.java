...
public final class RequestErrors {
	...
	public static void update(Context context) {
		...
		ErrorCategory e600408 = new ErrorCategory(600408, context.getString(R.string.not_completed_request), "No se ha recibido el algoritmo de firma en la firma batch");
