        ...
        saveChangesBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    CustomDialog cd = new CustomDialog(TrustedDomainsActivity.this, R.mipmap.error_icon, getString(R.string.error), "AA" + errorCat.getCode() + " - " + getString(R.string.error_format_trusted_domains, e.getMessage()), getString(R.string.understood));
                    cd.show();
                }
            }
        });
